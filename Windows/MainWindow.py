...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.actionGastos_3.triggered.connect(lambda :OpenGraphicsWindow("gastos", "Todos"))
        self.actionGastos_3.setObjectName("actionGastos_3")
        self.actionIngresos_3 = QtWidgets.QAction(self)
        self.actionIngresos_3.triggered.connect(lambda: OpenGraphicsWindow("ingresos", "Todos"))
        self.actionIngresos_3.setObjectName("actionIngresos_3")
        self.actionGastos_4 = QtWidgets.QAction(self)
        self.actionGastos_4.triggered.connect(lambda :OpenGraphicsWindow("gastos", "Diario"))
