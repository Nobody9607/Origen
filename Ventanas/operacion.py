...
class Ui_VentanasDeEntrada(object):
    def setupUi(self, VentanasDeEntrada):
        VentanasDeEntrada.setObjectName("VentanasDeEntrada")
        VentanasDeEntrada.resize(600, 300)
        VentanasDeEntrada.setMinimumSize(QtCore.QSize(600, 300))
        VentanasDeEntrada.setMaximumSize(QtCore.QSize(600, 300))
        VentanasDeEntrada.setStyleSheet("background-color: rgb(99, 99, 118);")
        self.pushButton = QtWidgets.QPushButton(VentanasDeEntrada)
...
"QPushButton:hover{background-color:rgb(158, 161, 180)}")
        ...
        self.pushButton_2 = QtWidgets.QPushButton(VentanasDeEntrada)
...
"QPushButton:hover{background-color:rgb(158, 161, 180)}")
        ...
        self.label = QtWidgets.QLabel(VentanasDeEntrada)
        ...
        self.lineEdit = QtWidgets.QLineEdit(VentanasDeEntrada)
        ...
        self.comboBox = QtWidgets.QComboBox(VentanasDeEntrada)
...
"")
        ...
        self.comboBox.addItem("")
        self.lineEdit_2 = QtWidgets.QLineEdit(VentanasDeEntrada)
        ...
        self.retranslateUi(VentanasDeEntrada)
        QtCore.QMetaObject.connectSlotsByName(VentanasDeEntrada)
...
if __name__ == "__main__":
    ...
    VentanasDeEntrada = QtWidgets.QDialog()
    ui = Ui_VentanasDeEntrada()
    ui.setupUi(VentanasDeEntrada)
    VentanasDeEntrada.show()
    sys.exit(app.exec_())
